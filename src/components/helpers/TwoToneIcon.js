...
export const getIcon = (type, size = 'sm') => {
    switch (type) {
        case 'income':
            return <TowToneIcon size={size} color={'emerald'} icon={<HiArrowDown className='rotate-45' />}/>
        case 'expense':
            return <TowToneIcon size={size} color={'red'} icon={<HiArrowUp className='rotate-45' />}/>
        default:
